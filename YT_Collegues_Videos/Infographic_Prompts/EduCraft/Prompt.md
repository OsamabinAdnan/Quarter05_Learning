# **Infographic Prompts for Images**

YT Video Link **[How I Make Accurate Study Notes With ChatGPT & Claude in 2 mins](https://www.youtube.com/watch?v=GLNl-NmeRJg)**

## Step 1: ChatGPT Synthesises The Information
...
You are an expert educational content planner and subject-matter explainer. Create an accurate, level-appropriate content blueprint for a handwritten educational infographic about this topic. First, identify the subject type, such as scientific concept, person, historical event, object, place, process, system, plan, or classroom concept. Then select 6–8 strong, topic-specific knowledge modules. Choose the modules automatically according to the topic and learning level. Do not force irrelevant categories into the structure. Possible module types include definition, identity, key features, parts, structure, composition, origin, background, development, chronology, location, context, function, mechanism, process, stages, types, classification, comparison, examples, evidence, relationships, applications, effects, misconceptions, or practical use.

For each selected module, provide:

-   a short module title
-   one short concept label, not an explanation or sentence
-   3–5 essential facts or ideas per module, chosen according to the topic: some modules may need 3 items, others 4 or 5. Do not force every module to have the same number, and do not add filler to reach 5. Write the exact compact text that will appear on the infographic: short bullets, fragments, labels, names, dates, numbers, or brief contrasts rather than complete sentences. Keep each item to one line and usually 3–10 words; use the fewest words needed to convey the key information. Wrap only the most important word or short phrase in ==double equals==, for example: ==photosynthesis== → ==glucose==, or LEVEL 8–10: ==OUT OF CONTROL==
-   only the most useful example, comparison, date, measurement, or relationship when essential; omit it if it would add clutter
...
Before you reply ensure that everything is based on the previous instructions and most importantly avoid repeating the same fact. Do not write the final infographic prompt yet. Return only the structured content blueprint.
```

### Route 1: ChatGPT Researches the information

For the demo, I asked ChatGPT to research the Hellenistic kingdoms and the Wars of the Diadochi.

---

<div align='center'>
    <img src='assets/ChatGPT-Step-1-Route-1.jpg' width='800' alt='ChatGPT Step 1 Route 1'>
    <p><b><u>ChatGPT Step 1 Route 1</u></b></p>
</div>

---

### Route 2: Using a PDF File instead

Have a document instead, say a set of lecture notes? The only extra step is uploading it. I uploaded a PDF about the Iran–Israel war, reran the first prompt, and **this time also switched on ‘Think’ mode.** That gives ChatGPT extra time to connect the details and double-check its own reasoning, a real help with longer or more complex documents.

Again, the only fields you customise are the topic and the learning level. Once ChatGPT hands back the structured blueprint, you have a verified scaffold, and that scaffold is what makes the visualisation step trustworthy.

---

<div align='center'>
    <img src='assets/ChatGPT-Step-1-Route-2.jpg' width='800' alt='ChatGPT Step 1 Route 2'>
    <p><b><u>ChatGPT Step 1 Route 2</u></b></p>
</div>

---


## Step 2: Turn It Into Sketchnote-Style Notes
...
<div align='center'>
    <img src='assets/ChatGPT-Step-2-Route-1-Reply.jpg' width='800' alt='ChatGPT Step 2 Route 1 Reply'>
    <p><b><u>ChatGPT Step 2 Route 1 Reply</u></b></p>
</div>

---


**The second prompt is deliberately strict.** It tells ChatGPT to treat the blueprint as the single source of truth, keep every fact compact, and never invent anything new. That’s the difference between a decorative image and a note that’s genuinely useful for studying.

## Step 3: Claude Checks Everything, Visuals Included

To make the checking fast and repeatable, I built a skill in Claude that double-checks everything you feed it: the facts, the sources, even the visuals. Here’s how I use it:

First I switch on the ‘deep-research syntheser’ skill. Then I upload the image ChatGPT created and ask Claude to analyse it. You might be wondering why I’m sending Claude the image instead of the text that came out of the first prompt.

Here’s why: Claude found several issues, including a problem with the map ChatGPT drew. So it isn’t just proofreading the words; it’s inspecting the illustration itself. That’s why I’d rather have it evaluate the final image than review a text answer.

---

<div align='center'>
    <img src='assets/Claude-Skill.jpg' width='800' alt='Claude Skill'>
    <p><b><u>Claude Skill</u></b></p>
</div>

---

Then the loop closes: copy Claude’s feedback, head back to ChatGPT, click ‘EDIT’ on the image, paste the feedback in, and let it revise.

And there it is: the same clean, visual sketchnote, but now every label, fact, and map on it is accurate and actually safe to study from. Total time: still under two minutes.

**Claude Skill:** Both prompts are right above; copy them straight from this post. And to turn Claude into your personal fact-checker, grab the skill file below: upload it to Claude, enable the ‘deep-research syntheser’ skill, and you’re ready to verify any note you generate.

---

<div align='center'>
    <img src='assets/Vertical-Diadochi.jpg' width='800' alt='Vertical Diadochi'>
    <p><b><u>Before Claude's Feedback</u></b></p>
</div>

---

<div align='center'>
    <img src='assets/Vertical-Diadochi-Correct.jpg' width='800' alt='Vertical Diadochi'>
    <p><b><u>After Claude's Feedback</u></b></p>
</div>
